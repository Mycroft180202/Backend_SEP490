...
const OrderManagement = () => {
  ...
  const [orders, setOrders] = useState([
    ...
    { id: 'ORD-011', customer: 'Võ Văn L', phone: '0923456701', product: 'Bát gốm vẽ tay', quantity: 4, amount: 1000000, status: 'Đang giao', date: '2025-11-03', payment: 'Đã thanh toán' },
    { id: 'ORD-012', customer: 'Đỗ Thị M', phone: '0934567012', product: 'Đĩa gốm sứ', quantity: 6, amount: 900000, status: 'Hoàn thành', date: '2025-11-03', payment: 'Đã thanh toán' },
  ]);
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Quản lý và theo dõi đơn hàng của shop</p>
          </div>
