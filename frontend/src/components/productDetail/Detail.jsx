      ...
      <div className="flex gap-10">
        <div className="flex-1 space-y-6">
          <div className="flex items-center gap-2">
             <a href="#description" className="text-[20px] text-[#9e211f] font-['Alata:Regular'] cursor-pointer hover:text-primary">
              Mô tả</a>
              <span className="w-2 h-2 rounded-full bg-[#9e211f] inline-block" />
              <a href="#feedback" className="text-[20px] text-[#a0a0a0] cursor-pointer hover:text-primary">
                Feedback (80)</a>
          </div>
