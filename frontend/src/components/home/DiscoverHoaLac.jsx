            ...
            <div className="flex flex-col items-center gap-6 w-full">
              <div className="flex flex-col items-start gap-6 w-full">
                <div className="flex items-center gap-[23px] w-full">
                  <div className="flex items-center gap-2 py-1.5 px-6 border-0.5 border-text-light rounded-xl flex-1">
                ...
                <div className="relative w-full">
                  <textarea 
                    ...
                    rows="3"
                    className="w-full py-3 px-4 border-0.5 border-text-light rounded-xl font-nunito text-lg text-text-light bg-transparent outline-none placeholder-text-light resize-none"
                  />
                  <svg className="absolute top-3 left-4 w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 11H7C4 11 2 13 2 16V17C2 20 4 22 7 22H17C20 22 22 20 22 17V16C22 13 20 11 17 11H16" stroke="#A0A0A0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M18.04 6.0198L10.16 13.8998C9.86 14.1998 9.56 14.7898 9.5 15.2198L9.07 18.2298C8.91 19.3198 9.68 20.0798 10.77 19.9298L13.78 19.4998C14.2 19.4398 14.79 19.1398 15.1 18.8398L22.98 10.9598C24.34 9.5998 24.98 8.0198 22.98 6.0198C20.98 4.0198 19.4 4.6598 18.04 6.0198Z" stroke="#A0A0A0" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M16.91 7.1499C17.58 9.5399 19.45 11.4099 21.85 12.0899" stroke="#A0A0A0" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>

                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full border border-text-light"></div>
              ...
              <div className="flex items-center justify-center gap-10">
                <a href="#" className="w-11 h-11 bg-[#0866FF] rounded-full flex items-center justify-center hover:opacity-90 transition-opacity">
                ...
                <a href="#" className="w-11 h-11 rounded-full flex items-center justify-center hover:opacity-90 transition-opacity" style={{background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f 60%,#285AEB 90%)'}}>
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.001 2.002c-5.522 0-9.999 4.477-9.999 9.999 0 4.99 3.656 9.126 8.437 9.879v-6.988h-2.54v-2.891h2.54V9.798c0-2.508 1.493-3.891 3.776-3.891 1.094 0 2.24.195 2.24.195v2.459h-1.264c-1.24 0-1.628.772-1.628 1.563v1.875h2.771l-.443 2.891h-2.328v6.988C18.344 21.129 22 16.992 22 12.001c0-5.522-4.477-9.999-9.999-9.999z"/>
                  </svg>
                </a>
                <div className="flex items-center gap-3">
                  <a href="#" className="w-11 h-11 bg-[#25D366] rounded-full flex items-center justify-center hover:opacity-90 transition-opacity">
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="flex flex-col -gap-0.5">
                    ...
                    <span className="font-nunito text-lg font-medium text-black text-center">0266211366</span>
                  </div>
                </div>
              </div>
            </div>
