      ...
      <div className="max-w-[1440px] mx-auto flex flex-col justify-center items-center gap-8">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
          <div className="flex flex-col gap-3">
            <h3 className="font-alata text-xl leading-8">Liên hệ</h3>
            <div className="flex flex-col gap-3">
              <div className="flex items-start gap-3">
                ...
                <span className="font-nunito text-base sm:text-lg leading-7">Hòa Lạc, Thạch Thất, Hà Nội</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="font-nunito text-base sm:text-lg leading-7">Hoalachandicraft@gmail.com</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="font-nunito text-base sm:text-lg leading-7">1234567890</span>
              </div>
            </div>
          </div>

          <div className="flex flex-col gap-3">
            <h3 className="font-alata text-xl leading-8">Cửa hàng</h3>
            <div className="flex flex-col gap-3">
              <a href="/shop/chuon-chuon" className="font-nunito text-base sm:text-lg leading-7 hover:text-yellow-200 transition-colors">
                Chuồn chuồn tre Thạch Xá
              </a>
              <a href="/shop/quat" className="font-nunito text-base sm:text-lg leading-7 hover:text-yellow-200 transition-colors">
                Quạt Quảng Sơn
              </a>
              <a href="/shop/may-tre" className="font-nunito text-base sm:text-lg leading-7 hover:text-yellow-200 transition-colors">
                Mây tre đan
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="font-alata text-xl leading-8">Chính sách</h3>
            <div className="flex flex-col gap-3">
              <a href="/policy/warranty" className="font-nunito text-base sm:text-lg leading-7 hover:text-yellow-200 transition-colors">
                Chính sách bảo hành
              </a>
              <a href="/policy/shipping" className="font-nunito text-base sm:text-lg leading-7 hover:text-yellow-200 transition-colors">
                Chính sách vận chuyển
              </a>
              <a href="/policy/return" className="font-nunito text-base sm:text-lg leading-7 hover:text-yellow-200 transition-colors">
                Chính sách đổi trả
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="font-alata text-xl leading-8">Khám phá</h3>
            <div className="flex flex-col gap-3">
              <a href="/blog" className="font-nunito text-base sm:text-lg leading-7 hover:text-yellow-200 transition-colors">
                Tin tức làng nghề
              </a>
              <a href="/collections" className="font-nunito text-base sm:text-lg leading-7 hover:text-yellow-200 transition-colors">
                Bộ sưu tập sản phẩm
              </a>
            </div>
          </div>
