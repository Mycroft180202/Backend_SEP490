...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_SEP490.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("ArtisanConfirmedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Backend_SEP490.Models.SellerReputation", b =>
                {
                    ...
                    b.ToTable("SellerReputations");
                });

            modelBuilder.Entity("Backend_SEP490.Models.SellerReputationHistory", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("SellerReputationHistories");
                });
            ...
            modelBuilder.Entity("Backend_SEP490.Models.SellerReputation", b =>
                {
                    b.HasOne("User", "Seller")
                        .WithOne("SellerReputation")
                        .HasForeignKey("Backend_SEP490.Models.SellerReputation", "SellerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Backend_SEP490.Models.SellerReputationHistory", b =>
                {
                    b.HasOne("Backend_SEP490.Models.SellerReputation", "Reputation")
                        .WithMany("Histories")
